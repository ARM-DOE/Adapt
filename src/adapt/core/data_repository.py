...
class DataRepository:
    ...
    def __init__(
        ...
        self.radar_catalog = RadarCatalog(self.base_dir / radar)
        ...
        logger.info(f"  Radar catalog: {self.radar_catalog.db_path}")
    ...
    def _register_in_new_catalog(self) -> None:
        ...
        config_path = None
        if self.config:
            config_file = self.radar_catalog.radar_dir / f"config_run_{self.run_id}.json"
    ...
    def register_artifact(
        ...
        try:
            ...
            self.radar_catalog.register_item(
    ...
    def write_analysis2d_parquet(
        ...
        analysis_dir = self.radar_catalog.radar_dir / "analysis"
        ...
        item_id = self.radar_catalog.register_item(
            item_id=item_id,
            run_id=self.run_id,
            item_type="analysis2d",
            scan_time=scan_time.isoformat(),
            file_path=str(parquet_path.relative_to(self.radar_catalog.radar_dir)),
