"""Output contracts for the detection module.

The detection module produces segmented cell labels. This module defines
the contract that validates the segmentation output structure.
